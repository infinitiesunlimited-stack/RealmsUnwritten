...
- Jobs, occupations, labor assignment, and needs — exclusive current-work commitment landed in 0.1E; optional current activity landed in 0.1J; authored Task Type identity landed in 0.1K; occupation, job markets, schedules, wages, task instances, and needs remain deferred
